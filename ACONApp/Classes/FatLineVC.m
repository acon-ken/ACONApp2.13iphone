...
#import "fatTableViewCell.h"// 自定义 cell

@interface FatLineVC ()<UITableViewDataSource,UITableViewDelegate>
{
...
-(void)createFatTableView{
    ...
    NSString *cellName = NSStringFromClass([fatTableViewCell class]);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    fatTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:NSStringFromClass([fatTableViewCell class])];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    return 170*XiShu_Height;
}

- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section{
    return 30*XiShu_Height;
}

- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    if (section==0) {
        //表头 提示  设置
        CGRect frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width , 30*XiShu_Height);
