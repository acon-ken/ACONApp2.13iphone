...
#import "ChooseViewController.h" //手动输入数据的类型

#import "ChooseDataListController.h"// 数据列表 类型

#import "ChooseLineVC.h"//选择数据类型 折线图  联网不需要
...
- (void)btnItem1Click
{
    ...
    ChooseDataListController *dataVC=[[ChooseDataListController alloc]init];
